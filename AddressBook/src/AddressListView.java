...
public class AddressListView {
	...
	public void setController(AddressList addressList) {
		...
		public void viewAddressEditForm(EntryData entries){
			...
			FormPanel submitPanel = makeSubmitPostForm(entries);
			mainPanel.add(submitPanel);
		}
		...
		private FormPanel makeSubmitPostForm(final EntryData entries){
			...
			titleTextbox.setName("address");
			descrText.setName("city");
			priceTextbox.setName("state");
